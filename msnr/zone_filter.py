...
Changes from v4:
  - Expanded PIP_SCALE to cover all 19 backtest pairs
  - JPY-quoted pairs use 0.01; non-JPY use 0.0001
  - XAUUSD uses 0.50 (validated by the earlier pip-scale fix)
"""
